                ...
                {items.map((item, index) => (
                  item.category === 'CATEGORY' ? (
                    <tr key={index} className="bg-blue-50">
                      <td colSpan={7} className="p-3 font-bold text-blue-800 border-b border-gray-300">
                        {item.item}
                      </td>
                    </tr>
                  ) : (
                    ...
                    >
                      ...
                      <td className={`p-2 border-b border-gray-300 ${item.completed ? 'line-through' : ''}`}>
                        {item.item}
                      </td>
                      <td className={`p-2 border-b border-gray-300 ${getPriorityColor(item.priority)} ${item.completed ? 'line-through' : ''}`}>
                        {item.priority}
                      </td>
                      <td className="p-2 border-b border-gray-300">
                        <select
